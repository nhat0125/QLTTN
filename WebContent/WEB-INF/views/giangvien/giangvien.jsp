...
<div class="row ">
        ...
        <div class="card-body ">
        <form:form modelAttribute="giangvien" action="../giangvien/tsxgv.htm">
        <div class="row">
        	<div class="col-md-2">
					<label>Mã giảng viên</label>
					<form:input path="maTaiKhoan" type="text" class="form-control"
						id="exampleFormControlInput1" placeholder="Nhập mã giảng viên" />
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-center text-uppercase text-xs font-weight-bolder opacity-10">Mã giảng viên</th>
                    ...
                    <c:forEach var="gv" items="${dsgiangvien}">
						<tr class="text-center text-secondary">
							...
							<td class="align-middle">
                        		<a href="../giangvien/${gv.maTaiKhoan}.htm?linkEdit" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
          							Chỉnh sửa
                        		</a>
                        		|
                        		<a href="../giangvien/${gv.maTaiKhoan}.htm?linkDelete" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
          							Xóa
                        		</a>
                      </td>
						</tr>
